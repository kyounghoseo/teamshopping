...
<a href="/shoppingmall/bookContent.do?book_id=${book.getBookid()}&book_kind=${book.getBook_kind()}">
<img src="/shoppingmall/bookImage/${book.getBook_image()}" class="listimage"></a></td>
<td width="350" class="vhcenter">
<a href="shoppingmallbookContent.do?book_id=${book.getBook_id()}&book_kind=${book.getBook_kind()}" class="b">${book.getBook_title()}</a></td>
<td rowspan="4" width="100">
...
<tr height="30">
<td width="350"><c:set var="price" value="${book.getBokk_price()}"/>
